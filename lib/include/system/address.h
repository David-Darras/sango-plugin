...
// Input
constexpr uptr kDeviceGetController = GAME_ADDRESS(0, 0x00117550);
constexpr uptr kControllerIsKeyPressed = GAME_ADDRESS(0, 0x004C86EC);
constexpr uptr kControllerIsKeyReleased = GAME_ADDRESS(0, 0x004C86B4);
constexpr uptr kControllerIsKeyRepeated = GAME_ADDRESS(0, 0x004C863C);
constexpr uptr kControllerIsKeyDown = GAME_ADDRESS(0, 0x004C8604);
constexpr uptr kControllerGetRepeatedKey = GAME_ADDRESS(0, 0x004C867C);
constexpr uptr kDeviceGetDpad = GAME_ADDRESS(0, 0x004C80E0);
constexpr uptr kDpadIsPressed = GAME_ADDRESS(0, 0x004C8030);
constexpr uptr kDpadIsRepeated = GAME_ADDRESS(0, 0x004C7F50);
constexpr uptr kDpadIsDown = GAME_ADDRESS(0, 0x004C7EF8);
constexpr uptr kDpadIsDown2 = GAME_ADDRESS(0, 0x004C7BEC);
constexpr uptr kDpadIsReleased2 = GAME_ADDRESS(0, 0x004C7C0C);
constexpr uptr kDeviceGetTouchscreen = GAME_ADDRESS(0, 0x004C810C);
constexpr uptr kTouchscreenIsPressed = GAME_ADDRESS(0, 0x004C77D4);
constexpr uptr kTouchscreenIsRepeated = GAME_ADDRESS(0, 0x004C7774);
constexpr uptr kTouchscreenIsReleased = GAME_ADDRESS(0, 0x004C77AC);
constexpr uptr kTouchscreenIsDown = GAME_ADDRESS(0, 0x004C79F8);
constexpr uptr kTouchscreenGetX = GAME_ADDRESS(0, 0x004C794C);
constexpr uptr kTouchscreenGetY = GAME_ADDRESS(0, 0x004C7974);
...
constexpr uptr kStringVtable = GAME_ADDRESS(0, 0x005DE3BC);
constexpr uptr kEntrypoint =
    GAME_ADDRESS(0, 0x00122938); // Render Home Button Blocked
...
constexpr uptr kStdVswprintf = GAME_ADDRESS(0, 0x001004B8 | 1);
...
constexpr uptr kMainProcessLoop = GAME_ADDRESS(0, 0x003AB62C);
constexpr uptr kMainEventLoop = GAME_ADDRESS(0, 0x00117E4C);
