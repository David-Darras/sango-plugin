...
constexpr uptr kLanguageId = GAME_ADDRESS(0, 0x005F4F01);
...
constexpr uptr kAppLayoutManagerShowPane = GAME_ADDRESS(0, 0x00361A10);
constexpr uptr kAppLayoutManagerShowAnimation = GAME_ADDRESS(0, 0x00361410);
constexpr uptr kAppLayoutManagerHideAnimation = GAME_ADDRESS(0, 0x00363334);
constexpr uptr kAppLayoutManagerGetToken = GAME_ADDRESS(0, 0x004C6594);
constexpr uptr kAppLayoutManagerSetTextBoxString = GAME_ADDRESS(0, 0x004195F4);
constexpr uptr kAppLayoutManagerGetTextBox = GAME_ADDRESS(0, 0x004C8CE0);

constexpr uptr kKeyboardWordFilter = GAME_ADDRESS(0, 0x003A47C0);
constexpr uptr kKeyboardWordFilterReturn = GAME_ADDRESS(0, 0x003A47C4);
constexpr uptr kKeyboardCalculateKeyIndex = GAME_ADDRESS(0, 0x004C5924);
...
constexpr uptr kAppLayoutManagerGetPicture = GAME_ADDRESS(0, 0x004C8C88);
constexpr uptr kAppLayoutManagerGetPane = GAME_ADDRESS(0, 0x004C9140);
