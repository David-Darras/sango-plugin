...
constexpr uptr kGlobalDataItemGetName = GAME_ADDRESS(0, 0x003B7A64);
constexpr uptr kGlobalDataItemInitialize = GAME_ADDRESS(0, 0x003B7B9C);
constexpr uptr kGlobalDataPokemonTable = GAME_ADDRESS(0, 0x00617A00);
constexpr uptr kGlobalDataMoveTable = GAME_ADDRESS(0, 0x0062B3A0);
...
constexpr uptr kGlobalDataItemGetParam = GAME_ADDRESS(0, 0x004D3C84);
constexpr uptr kGlobalDataLoadEvolveTable = GAME_ADDRESS(0, 0x003B1108);
constexpr uptr kGlobalDataLoadMegaEvolutionTable = GAME_ADDRESS(0, 0x00168974);
...
constexpr uptr kGlobalDataTable = GAME_ADDRESS(0, 0x00617A00);
constexpr uptr kGlobalDataEvolveTable = kGlobalDataTable + 0x04 + 0x34;
constexpr uptr kGlobalDataMegaEvolutionTable = kGlobalDataTable + 0x04 + 0x40;
constexpr uptr kGlobalDataAbilityNameMessage = kGlobalDataTable + 0x0C;
constexpr uptr kGlobalDataAbilityDescriptionMessage = kGlobalDataTable + 0x10;
constexpr uptr kGlobalDataMoveNameMessage = kGlobalDataTable + 0x6C;
constexpr uptr kGlobalDataLoadMovepool = GAME_ADDRESS(0, 0x0014EB80);
constexpr uptr kGlobalDataMovepool = GAME_ADDRESS(0, 0x08029330);
