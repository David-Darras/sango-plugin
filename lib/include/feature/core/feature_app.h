...
public:
  STATIC_INLINE void Initialize() {
    ...
    WRITE32(ADDRESS_OVERWORLD_MENU_APP_ALLOC_SIZE, 0xE3A01C01); // Overworld Menu
    WRITE32(ADDRESS_TOP_MENU_APP_ALLOC_SIZE, 0xE3A01C01); // Top Menu
  ...
  static void TownMapCallback(uptr* data, game::Manager* manager) {
    ...
    ((void(*)(uptr*, void*))ADDRESS_TOWN_MAP_CALLBACK)(data, manager);
  }
