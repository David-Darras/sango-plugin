...
#define ADDRESS_OVERWORLD_SET_DEFAULT_POSITION (0x004040E4)
...
#define ADDRESS_OVERWORLD_CALL_SCRIPT_VTABLE (0x005DF018)
...
#define ADDRESS_LOAD_WORLD_LAYOUT (0x004072A4)
#define ADDRESS_MAP_SETTINGS_TABLE (0x005F45BC)
#define MAP_SETTINGS_TABLE_COUNT (536)
/** @} */
