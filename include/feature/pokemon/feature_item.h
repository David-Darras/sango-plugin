...
class Item {
  ...
  STATIC_INLINE void Initialize() {
    ...
    if (feat.remove_limit) {
      ...
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_1, 0xE35B00FF);
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_2, 0xE35B00FF);
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_3, 0xE35800FF);
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_4, 0xE35900FF);
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_5, 0xE35A00FF);
      WRITE32(ADDRESS_ITEM_EV_STAT_LIMIT_CHECK_6, 0xE35A00FF);
    }
